                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        while($row=$res->fetch_object())
                                            {
                                                ?>
                                        <tr><td><?php echo htmlspecialchars ($cnt);;?></td>
                                        ...
                                        <td>
                                        <a href="students-profile.php?id=<?php echo htmlspecialchars ($row->id);?>" title="View Full Details"><i class="icon-size-fullscreen"></i></a>&nbsp;&nbsp;
